...
[objNull, format ["Client FPS Anzeige für alle Zeuse %1.",if (prometheus_zeus_updateFPS) then {"eingeschaltet"} else {"ausgeschaltet"}]] call bis_fnc_showCuratorFeedbackMessage;
